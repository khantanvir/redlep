...
export default class Blog extends Component {
	...
	componentDidMount(){
		...
		axios.get(Config.base_url+'api/get/blog/list')
		.then(response=>{
			this.setState({
	...
	handlePageChange(pageNumber) {
	    ...
	    axios.get(Config.base_url+'api/get/blog/list?page='+pageNumber)
		.then(response=>{
			this.setState({
				blogs:response.data.result.val.data,
				itemsCountPerPage:response.data.result.val.per_page,
			                        ...
			                        <div className="post-wrap">
			                            <div className="media post">
			                                ...
			                                <div className="media-body">
			                                    ...
			                                    <a id={'detailid'+item.id} data-id={item.url} onClick={this.blogDetail.bind(this,item.id)} href={'#'}>
			                            ...
			                            <div className="post-meta">
			                                <ul className="list-inline metas pull-left">
			                                    ...
			                                    <li><a id={'readdetailid'+item.id} data-id={item.url} onClick={this.blogDetail.bind(this,item.id)} href="#">Read More</a></li>
			                                </ul>
			                            ...
			                            <div className="widget categories">
			                                ...
			                                <ul className="list-unstyled bullet-lists">
			                                {
			                                	this.state.catagories.map(catagory=>{
			                                		return(
			                                			<li><a id={'getData'+catagory.id} onClick={this.searchByCatagoryBlog.bind(this,catagory.id)} data-id={catagory.url} href="javascript://"><span className="fa fa-circle"></span>{catagory.title}</a></li>
			                                			)
			                                	})
