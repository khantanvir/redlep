...
class Redlep
{
    ...
    public static function encryptPassword($value){
        ...
        $crypttext = mcrypt_encrypt(MCRYPT_RIJNDAEL_256, 'SECURE_STRING_11', $value, MCRYPT_MODE_ECB, 'SECURE_STRING_22');
        return trim(base64_encode($crypttext));
    }

    public static function decryptPassword($value){
        if(!$value) return false;

        $crypttext = base64_decode($value);
        $decrypttext = mcrypt_decrypt(MCRYPT_RIJNDAEL_256, 'SECURE_STRING_11', $crypttext, MCRYPT_MODE_ECB, 'SECURE_STRING_22');
